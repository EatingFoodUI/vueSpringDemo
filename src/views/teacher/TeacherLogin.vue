    ...
    <div class="login_box">
        ...
        <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="0px" class="login_form">
            ...
            <el-form-item prop="TeacherId">
                <el-input v-model="loginForm.TeacherId" prefix-icon="el-icon-user"></el-input>
            </el-form-item>
            <!--密码-->
            <el-form-item prop="TeacherPwd">
                <el-input v-model="loginForm.TeacherPwd" prefix-icon="el-icon-lock" type="TeacherPwd"></el-input>
            </el-form-item>
            <!--按钮-->
            ...
            this.$refs.loginFormRef.validate(async (valid) => {
                ...
                await this.$http({
                    ...
                    res => {
                        ...
                        window.sessionStorage.setItem("teacherId", this.loginForm.TeacherId);
